            ...
            <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td colspan="5"><div align="center">
                  <html:form action="updatealbumInfo.do" onsubmit="return validateUpdateAlbumForm(this);">
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td>&nbsp;</td>
                        <td width="100">&nbsp;</td>
                      ...
                      <tr>
                        ...
                        <td><html:text property="name" styleClass="input" value="${requestScope.album.name}"/></td>
                      ...
                      <tr>
                        ...
                        <td colspan="2">
			<html:textarea property="desc" cols="40" rows="5" styleClass="input3" value="${requestScope.album.desc}"/></td>
                        </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td class="Statistic2">&nbsp;</td>
